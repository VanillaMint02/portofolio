...
export class PortfolioEntryMapper {
    static mapCreatePortfolioEntryToDomain(createPortfolioEntryDto: CreatePortfolioEntryDto): PortfolioEntryDomain {
    ...
    static mapToDto(portfolioEntryDomain: PortfolioEntryDomain): PortfolioEntryDto {
    ...
    static mapToDomain(portfolioEntryDto: PortfolioEntryDto): PortfolioEntryDomain {
        return new PortfolioEntryDomain({
