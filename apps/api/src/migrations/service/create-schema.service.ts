...
export class CreateSchemaService{
    ...
    public static async createSchemaWithSchemaName(schemaName:string,queryRunner:QueryRunner):Promise<void>{
        ...
        await queryRunner.createForeignKey(`${schemaName}.portfolio_entry_domain`, userIdForeignKey);
        await queryRunner.createTable(
            new Table({
        ...
        await queryRunner.createForeignKey(`${schemaName}.file_link_domain`,portfolioIdForeignKey);
        await queryRunner.createForeignKey(`${schemaName}.file_link_domain`,parentIdForeignKey);
        
    }
    public static async dropTablesWithSchemaName(schemaName:string, queryRunner:QueryRunner){
